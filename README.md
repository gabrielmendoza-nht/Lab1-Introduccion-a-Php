...
```
2. Colócalo dentro del directorio de tu servidor local (por ejemplo, `htdocs` si usas XAMPP, o `www` si usas WAMP/MAMP).
3. Inicia Apache y PHP desde tu panel de control (XAMPP/WAMP/MAMP) o ejecuta el servidor embebido de PHP:
```bash
   php -S localhost:8000
```
4. Abre tu navegador en `http://localhost:8000/calculadora.php` (o el archivo que quieras probar).
## 📌 Requisitos
